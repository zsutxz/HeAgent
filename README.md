...
运行时目标产物在 `_he-output/goals/<goal-id>/`；步骤、产物与维护规则详见[文档索引的「Goal 工作流」章节](docs/README.md#goal-工作流)。历史规划材料位于 [`_bmad-output/`](_bmad-output/README.md)，不作为当前运行时配置。
...
| `/goal` 工作流、产物与维护规则 | [文档索引「Goal 工作流」](docs/README.md#goal-工作流) |
