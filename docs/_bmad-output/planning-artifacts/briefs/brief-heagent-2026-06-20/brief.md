...
- ⚠️ **时间窗口**：当前 MCP 协议 stable 为 `2025-11-25`，但 `2026-07-28` RC 是 breaking change（转向 stateless、删除 `initialize` 握手）。V1 落在 stable 版，但适配层设计须为这次迁移留好接口。详细技术速览见 `addendum.md`。
