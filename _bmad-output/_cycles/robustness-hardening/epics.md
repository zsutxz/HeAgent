...
inputDocuments:
  - _bmad-output/_cycles/robustness-hardening/brief.md
  - _bmad-output/_cycles/robustness-hardening/prd.md
  - _bmad-output/_cycles/robustness-hardening/ARCHITECTURE-SPINE.md
...
**When** 新建维护
**Then** `_bmad-output/_cycles/robustness-hardening/sprint-status.yaml` 跟踪 Epic 18/19 的 story 状态
