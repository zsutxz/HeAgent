...
### References
- [Source: _bmad-output/_cycles/baseline/architecture.md#Complete Project Directory Structure]
- [Source: _bmad-output/_cycles/baseline/architecture.md#依赖版本锁定]
- [Source: _bmad-output/_cycles/baseline/prd.md#6. MVP 范围]
