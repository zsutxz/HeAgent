...
摘自 `_bmad-output/mcp/ARCHITECTURE-SPINE.md`：
...
- [Source: `_bmad-output/mcp/epics.md`#Story A.1] —— AC verbatim 来源
- [Source: `_bmad-output/mcp/ARCHITECTURE-SPINE.md`#AD-1] —— annotations 经 ToolSchema 注入
- [Source: `_bmad-output/mcp/ARCHITECTURE-SPINE.md`#Consistency Conventions] —— 数据模型约定（丢 title、四 hint、None 语义）
- [Source: `_bmad-output/mcp/ARCHITECTURE-SPINE.md`#Inherited Invariants] —— DAG（types 不上浮 mcp）
