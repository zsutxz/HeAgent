...
- **v1 线最新 stable：1.28.1**（1.28.0 / 1.28.1 均存在，截至 2026-07-12 PyPI）；前序 1.27.2（2026-05-29）、1.27.1（2026-05-08）、1.27.0（2026-04-02）。HeAgent 现 pin `mcp>=1.28,<2`（mcp-client Story 1.1，2026-06-20 起），本周期 bump floor 到 `mcp>=1.28.1,<2` 锁最新。
- **【订正 2026-07-12】** 原 research digest 误断「v1 最新 stable = 1.27.2 / 无 1.28.x」（rubric review F1 据此误 CONFIRMED）。实际 1.28.0 早在 2026-06-20 已被本仓库安装（mcp-client Story 1.1 commit `5b6453f`），1.28.1 为当前最新。故 mcp-client prd §6「v1.28.0 stable」**非笔误、正确**；FR-1/Story 14-1 已据此重定为「bump floor 到 1.28.1」（非降级到 1.27.2）。
