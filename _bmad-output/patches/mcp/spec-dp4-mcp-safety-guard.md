...
- `_bmad-output/epics/epic-01-10-主线规划周期/sprint-status.yaml` — `action_items` DP-4 项 status `open → closed`
...
- [x] `docs/frame.md` + `_bmad-output/epics/epic-01-10-主线规划周期/sprint-status.yaml` -- 更新已知缺口 + action_items DP-4 关闭 -- 同步架构权威
