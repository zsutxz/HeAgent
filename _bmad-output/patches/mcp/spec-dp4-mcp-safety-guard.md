...
- `_bmad-output/sprint-status.yaml` — `action_items` DP-4 项 status `open → closed`
...
- [x] `docs/frame.md` + `_bmad-output/sprint-status.yaml` -- 更新已知缺口 + action_items DP-4 关闭 -- 同步架构权威
